...
// =====================================================================
  ...
  const category = config.category ? config.category : [{"name": "前端","path": "/categories/前端/","shadow":"var(--anzhiyu-shadow-blue)"},{"name": "大学","path": "/categories/大学/","shadow":"var(--anzhiyu-shadow-red)"},{"name": "生活","path": "/categories/生活/","shadow":"var(--anzhiyu-shadow-green)"}]
  // 如果配置开启
  ...
  // 集体声明配置项
    const data = {
      ...
      category: category,
      categorygroup_css: config.categorygroup_css ? urlFor(config.categorygroup_css) : "https://cdn.cbd.int/hexo-butterfly-swiper-anzhiyu-pro/lib/categoryGroup.css",
    }
  // 渲染页面
  ...
  //cdn资源声明
    //样式资源
  const css_text = `<link rel="stylesheet" href="${data.swiper_css}" media="print" onload="this.media='all'"><link rel="stylesheet" href="${data.custom_css}" media="print" onload="this.media='all'"><link rel="stylesheet" href="${data.categorygroup_css}" media="print" onload="this.media='all'">`
    //脚本资源
